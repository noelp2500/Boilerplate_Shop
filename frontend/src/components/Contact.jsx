    ...
    >
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
        ...
        <p className="text-gray-600 text-center mb-4">
          This is a usable template to - Fill out the form below or contact us
          directly
        </p>
        ...
        <div className="mt-8 text-center">
          <h2 className="text-lg font-semibold">Further Contact Information</h2>
          <div className="flex flex-col items-center space-y-2 mt-4">
            <div className="flex items-center">
              <FaPhone className="text-green-500 mr-2" />
              <span className="text-gray-600">+1(209)-3082144</span>
            </div>

            <div className="flex items-center">
              <FaEnvelope className="text-green-500 mr-2" />
              <span className="text-gray-600">npereira4@ucmerced.edu</span>
            </div>

            <div className="flex items-center">
              <FaMapMarkedAlt className="text-green-500 mr-2" />
              <span className="text-gray-600">Merced, CA</span>
            </div>
          </div>
        </div>
      </div>
