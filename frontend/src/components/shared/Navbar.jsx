...
const Navbar = () => {
  ...
  return (
    <>
      <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
        <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
          <Link to="/" className="flex items-center text-2xl font-bold">
            <FaShop className="mr-4 text-3xl" />
            <span className="font-[Poppins]">Boilerplate Online Store</span>
          </Link>
      ...
      <div className="p-2 mt-4 bg-red-100 flex flex-col justify-center items-center space-y-2 rounded-lg">
        <h3 className="text-slate-800 text-4xl font-bold text-center">
          This boilerplate can be accessed here -
          <a
            href="https://github.com/noelp2500/Boilerplate_Shop"
